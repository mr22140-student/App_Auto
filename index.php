...
<body>
    ...
    <div class="main">
        <div class="card-custom text-center py-5 mb-4">
            <h1 class="display-4 text-white mb-3 fw-semibold">Bienvenido al ERP Auto Repuestos</h1>
            
            <p class="lead text-white-50">Sistema integrado de inventario, facturación multimétodo y contabilidad automatizada por partida doble.</p>
            
            <hr class="my-4 border-secondary" style="max-width: 400px; margin: auto; opacity: 0.3;">
